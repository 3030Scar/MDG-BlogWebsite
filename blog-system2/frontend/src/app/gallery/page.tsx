      ...
      <div className="mx-auto max-w-screen-xl px-6 sm:px-10 md:px-16 lg:px-20">
        ...
        >
          <div className="flex items-center justify-center mb-3">
            <div className="hidden md:block"><SiliconIcon /></div>
            <h1
            ...
            >
              这里先放着，过会删
              <span className="absolute -top-4 -right-6 text-sm font-normal text-[#45B7D1] dark:text-[#56CFE1]">
                于光影间，定格诗篇
              </span>
            </h1>
            <div className="hidden md:block"><CloudFluteIcon /></div>
          </div>
